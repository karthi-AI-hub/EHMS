...
const ReportUpload = () => {
  ...
  const onDrop = (acceptedFiles) => {
    ...
    const totalSize = [...selectedFiles, ...validFiles].reduce(
      (acc, file) => acc + file.size,
      0
    );

    if (totalSize > 10 * 1024 * 1024) { // Increased to 10MB for better UX
    ...
    try {
      ...
      setError(
        error.response?.data?.message ||
          "Failed to upload the reports. Please try again."
      );
    } finally {
      setLoading(false);
      setProgress(0);
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            <Typography variant="h6" gutterBottom>
              {isDragActive ? 'Drop your reports here' : 'Drag & drop PDF files'}
            </Typography>
          ...
          >
            ...
            <Button
              ...
              disabled={
                ...
                ((reportType === "Lab" || reportType === "Pharmacy") && subtype === "All") || // Subtype is "All" for Lab or Pharmacy
